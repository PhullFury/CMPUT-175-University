def bitonic100(List):
	...
	if (List[83] < List[85]):
		List[83], List[85] = List[85], List[83]
	if (List[84] < List[86]):
		List[84], List[86] = List[86], List[84]
	if (List[83] < List[84]):
	...
	if (List[82] > List[86]):
		List[82], List[86] = List[86], List[82]
	if (List[79] > List[81]):
		List[79], List[81] = List[81], List[79]
	if (List[80] > List[82]):
	...
	if (List[87] < List[89]):
		List[87], List[89] = List[89], List[87]
	if (List[88] < List[89]):
		List[88], List[89] = List[89], List[88]
	if (List[91] < List[92]):
	...
	if (List[91] < List[92]):
		List[91], List[92] = List[92], List[91]
	if (List[94] < List[95]):
		List[94], List[95] = List[95], List[94]
	if (List[93] > List[95]):
		List[93], List[95] = List[95], List[93]
	if (List[94] > List[95]):
		List[94], List[95] = List[95], List[94]
	if (List[96] < List[97]):
		List[96], List[97] = List[97], List[96]
	if (List[98] > List[99]):
		List[98], List[99] = List[99], List[98]
	if (List[96] < List[98]):
		List[96], List[98] = List[98], List[96]
	if (List[97] < List[99]):
	...
	if (List[92] < List[96]):
		List[92], List[96] = List[96], List[92]
	if (List[93] < List[97]):
		List[93], List[97] = List[97], List[93]
	if (List[94] < List[98]):
		List[94], List[98] = List[98], List[94]
	if (List[95] < List[99]):
		List[95], List[99] = List[99], List[95]
	if (List[92] < List[94]):
		List[92], List[94] = List[94], List[92]
	if (List[93] < List[95]):
		List[93], List[95] = List[95], List[93]
	if (List[92] < List[93]):
	...
	if (List[82] > List[83]):
		List[82], List[83] = List[83], List[82]
	if (List[84] > List[92]):
		List[84], List[92] = List[92], List[84]
	if (List[85] > List[93]):
	...
	if (List[91] > List[99]):
		List[91], List[99] = List[99], List[91]
	if (List[84] > List[88]):
		List[84], List[88] = List[88], List[84]
	if (List[85] > List[89]):
	...
	if (List[66] < List[67]):
		List[66], List[67] = List[67], List[66]
	if (List[68] < List[84]):
		List[68], List[84] = List[84], List[68]
	if (List[69] < List[85]):
	...
	if (List[83] < List[99]):
		List[83], List[99] = List[99], List[83]
	if (List[68] < List[76]):
		List[68], List[76] = List[76], List[68]
	if (List[69] < List[77]):
	...
	if (List[68] < List[69]):
		List[68], List[69] = List[69], List[68]
	if (List[70] < List[71]):
		List[70], List[71] = List[71], List[70]
	if (List[72] < List[74]):
		List[72], List[74] = List[74], List[72]
	if (List[73] < List[75]):
		List[73], List[75] = List[75], List[73]
	if (List[72] < List[73]):
		List[72], List[73] = List[73], List[72]
	if (List[74] < List[75]):
		List[74], List[75] = List[75], List[74]
	if (List[76] < List[80]):
		List[76], List[80] = List[80], List[76]
	if (List[77] < List[81]):
		List[77], List[81] = List[81], List[77]
	...
	if (List[34] > List[35]):
		List[34], List[35] = List[35], List[34]
	if (List[36] > List[68]):
		List[36], List[68] = List[68], List[36]
	if (List[37] > List[69]):
