class BoundedQueue: 
    ...
    def enqueue(self, item): 
        ...
        ##### START CODE HERE #####
        if (self.isFull()):
            raise Exception("Try to enqueue a full bounded queue...")
        else:
    ...
    def dequeue(self):        
        ...
        try:
            ...
            print(LenError.args[0])
            raise Exception("Try to dequeue an empty bounded queue... ")
        else:
            self.__items.pop(0)
            return Item
        #####  END CODE HERE ######
...
class CircularQueue:
    ...
    def enqueue(self, item): 
        ...
        ##### START CODE HERE #####
        NeedLoop = True
        for i in range(self.__head, self.capacity()):
    ...
    def dequeue(self):        
        ...
        try:
            ...
            print(SizeError.args[0])
            raise Exception("Can't remove item from an empty queue.")
        else:
            self.__items.pop(self.__head)
            self.__count -= 1
            self.__head += 1
            return Item
        #####  END CODE HERE ######            
